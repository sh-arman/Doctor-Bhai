							...
							<div class="profile">
								<div class="row">
									<div class="col-lg-5 col-md-4">
										<figure>
											<img src="{{asset($doctor->user->avatar)}}" alt="" class="img-fluid" height="200px" width="200px">
										</figure>
									</div>
									<div class="col-lg-7 col-md-8">
										<small>{{$doctor->department->name}}</small>
										<h1><strong>{{$doctor->user->name}}</strong></h1>
										<ul class="statistic">
											<li>854 Views</li>
											<li>124 Patients</li>
										</ul>
				...
				<aside class="col-xl-4 col-lg-4" id="sidebar">
					<div class="box_general_3 booking">
						{{-- <form> --}}
							<div class="title">
							<h3>Book a Visit</h3>
							<strong>Monday to Friday {{$doctor->user->description}}</strong>
							</div>
							<!-- /row -->
							<ul class="treatments clearfix">
								<li>
									<div class="checkbox">
										...
										<label for="visit1" class="css-label">{{$doctor->department->name}} <strong>{{$doctor->bill}} tk</strong></label>
									</div>
								</li>
							</ul>
							<hr>
							@if(Auth::user())
                <a href="{{route('patient.appointment.take',['id' => $doctor->id])}}" class="btn_1 full-width"><strong>Book Now</strong></a>
              @else
                <div class="message">
