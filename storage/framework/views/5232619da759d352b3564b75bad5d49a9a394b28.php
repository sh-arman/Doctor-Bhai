              ...
              <tr rowsapn="2">
                ...
                <td><?php echo e($appointment->time); ?></td>
                  <td class="text-center">
                    <a href="<?php echo e(route('doctor.appointment.view',['id' => $appointment->id])); ?>" class="btn btn-primary">View</a>
                  </td>
                  <td class="text-center">
                    <a href="<?php echo e(route('doctor.appointment.reject',['id' => $appointment->id])); ?>" class="btn btn-danger">Reject</a>
                  </td>
              </tr>
