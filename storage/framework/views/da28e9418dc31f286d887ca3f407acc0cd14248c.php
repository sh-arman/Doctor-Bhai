			...
			<div class="row">
							...
							<div class="profile">
								<div class="row">
									<div class="col-lg-5 col-md-4">
										<figure>
											<img src="<?php echo e(asset($doctor->user->avatar)); ?>" alt="" class="img-fluid">
										</figure>
									</div>
									<div class="col-lg-7 col-md-8">
										<small><?php echo e($doctor->department->name); ?></small>
										<h1><?php echo e($doctor->user->name); ?></h1>
										<ul class="statistic">
											<li>854 Views</li>
											<li>124 Patients</li>
										</ul>
				...
				<aside class="col-xl-4 col-lg-4" id="sidebar">
					<div class="box_general_3 booking">
							...
							<div class="title">
							<h3>Book a Visit</h3>
							<small>Monday to Friday <?php echo e($doctor->user->description); ?></small>
							</div>
							<!-- /row -->
							...
							<hr>
							<?php if(Auth::user()): ?>
                <a href="<?php echo e(route('patient.appointment.take',['id' => $doctor->id])); ?>" class="btn_1 full-width">Book Now</a>
              <?php else: ?>
                <div class="message">
